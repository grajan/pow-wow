            ...
            public void onLoadPoi(final POI startPOI) {
                poiDatabase.loadPOI("126", new POIDatabase.OnLoadPoiListener() {
                    ...
                    public void onLoadPoi(final POI endPOI) {
                        ...
                        //Assign a POI Id to the Position startPosition by getting the POIs Id.
                        .poiId(startPOI.getId())
                        ...
                        .name(endPOI.getName())
                        //Assign a POI Id to the Position endPosition by getting the POIs Id.
                        .poiId(endPOI.getId())
